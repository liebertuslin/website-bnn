<?php 
  ...
  $ambil = $koneksi->query("SELECT * FROM golongan WHERE id_golongan='$id_narkotika'");
...
<head>
  <meta charset="UTF-8">
  <title>Golongan Narkotika</title>
        ...
        <div class="col-md-8 mb-5">
          <article class="artikel-website mt-5">
            <div class="container artikel">
              ...
              <a href="../narkotika.php" class="btn btn-outline-default">Back to posts</a>
            </div>
          </article>
        </div>
      </div>
